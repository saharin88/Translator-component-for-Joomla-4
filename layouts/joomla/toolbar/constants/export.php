...
$url = Uri::base().'index.php?option=com_translator&view=constants&layout=export&tmpl=component&to_file='.$to_file.'&file=';
$js  = <<< JS
...
<div class="float-end ms-2">
    <div class="form-inline mt-1">
        <div class="form-group">
            <label for="<?= $name ?>" class="float-left mr-2" data-toggle="tooltip" title="<?= Text::_('COM_TRANSLATOR_EXPORT_FROM_DESC') ?>"><?= Text::_('COM_TRANSLATOR_EXPORT_FROM_LABEL') ?></label>
